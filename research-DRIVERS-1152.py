...
This only hiccup with this plan is that on MongoDB <=3.2 this exists an error code 10058 that seems l: https://github.com/mongodb/mongo/blob/v3.2/src/mongo/db/instance.cpp#L1148

However, I'm unable to get the server to actually return the 10058 error code. Maybe OP_INSERT?
