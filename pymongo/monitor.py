...
class Monitor(MonitorBase):
    ...
    def gc_safe_close(self):
        super(Monitor, self).gc_safe_close()
        self._rtt_monitor.close()
        self.cancel_check()
        ...
        try:
            ...
            try:
                ...
                if prev_sd.is_server_type_known:
                    ...
                    # Note: This shaves off 10 seconds from the retryable
                    # reads test suite.
    ...
    def _check_once(self):
        ...
        address = self._server_description.address
        if self._publish:
            # TODO: Add the "awaited" field to heartbeat events. Spec test?
